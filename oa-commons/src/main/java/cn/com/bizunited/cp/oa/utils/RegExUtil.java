...
public class RegExUtil {
	...
	public static String REG_PHONE = "(^1(3|4|5|7|8)\\d{9}$)|(^0(\\(\\d{2,3}\\)|\\d{2,3}-|\\s)?\\d{7,14}$)|(^\\d\\d{5,6}\\d$)";
	public static String REG_CARD_15 = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";
	public static String REG_CARD_18 = "^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{4}$";

	public static void main(String[] args) {
		Matcher matcher = eregMatcher(REG_CARD_15, "123456789011111");
		if(matcher.find()){
			String group = matcher.group(2);
			System.out.println(group);
		}
		System.out.println(ereg(REG_CARD_15, "123456789011111"));
	}
	 ...
	 * @return
	 */
	public static boolean isMobileOrTel(String tel){
		if(tel == null) return  false;
		return  ereg(REG_PHONE, tel);
	}
	 ...
	 * @since 1.0
	 */
	public static final Matcher eregMatcher(String pattern, String str) throws PatternSyntaxException {
		try {
			Pattern p = Pattern.compile(pattern);
			Matcher m = p.matcher(str);
			return m;
